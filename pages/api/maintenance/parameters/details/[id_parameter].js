...
function handler (req, res) {
  ...
  async function get () {
    ...
    if (!idParameter) {
      throw new Error('No especificó el parametro que desea ver')
    }
    ...
    const buildWhereMain = {
      ID_DEFINITION_MASTER: idParameter
    }
    const buildWhereSecondary = {
      DEFINITION_MASTER_ID: idParameter
    }
